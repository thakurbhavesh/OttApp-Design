...
const styles = StyleSheet.create({
  ...
  displayName: { color: "#fff", fontSize: width * 0.065, fontWeight: "800", marginBottom: 10, textAlign: "center" },
  ...
  modalTitle: { color: "#fff", fontSize: width * 0.05, fontWeight: "700", flex: 1, textAlign: "center" },
  ...
  pickerWrapper: { backgroundColor: "#1a1a1a", borderRadius: 12, borderWidth: 1, borderColor: "#333", overflow: "hidden" },
  picker: { color: "#fff", height: Platform.OS === "ios" ? 120 : 50 },
  currentPlanNote: { color: ACCENT, fontSize: width * 0.04, textAlign: "center", marginBottom: 10, fontWeight: "600" },
  subscriptionDescription: { color: "#aaa", fontSize: width * 0.04, textAlign: "center", marginBottom: 30, lineHeight: 22 },
  planCard: {
    backgroundColor: "#1a1a1a",
    borderRadius: 15,
    padding: 20,
  ...
  popularBadge: { position: "absolute", top: -8, right: 20, backgroundColor: "#e91e63", paddingHorizontal: 12, paddingVertical: 4, borderRadius: 10 },
